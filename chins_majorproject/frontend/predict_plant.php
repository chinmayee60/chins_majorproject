...
<div class="fixed-sidebar-menu">
    ...
    <nav class="nav flex-column flex-1 py-4">
      ...
      <a class="nav-link active" href="predict_plant.php">🌱 Plant Disease Detection</a>
...
<div class="main-content-area flex flex-1 justify-center py-10 sm:py-16">
    <div class="w-full max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col items-center gap-2 mb-10 text-center">
            <p class="text-4xl font-black tracking-tighter sm:text-5xl text-text-light dark:text-text-dark">Diagnose Plant Health</p>
            <p class="max-w-xl text-base text-subtle-light dark:text-subtle-dark">Upload a clear image of your plant's leaves to get an instant diagnosis via Port 5000.</p>
        </div>

        <section id="upload-section" style="<?php echo $has_result ? 'display: none;' : ''; ?>">
            <form action="action_predict.php" method="POST" enctype="multipart/form-data" id="plant-diagnosis-form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 p-4">
                ...
                <div class="flex flex-col justify-center gap-6">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3 pt-4">
                        ...
                        <button onclick="window.location.href='predict_plant.php';" class="flex w-full sm:w-auto items-center justify-center rounded-lg h-11 px-5 bg-primary text-background-dark text-sm font-bold shadow-sm hover:brightness-110 transition-all">
